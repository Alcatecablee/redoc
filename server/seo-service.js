...
export class SEOService {
     ...
     */
    async generateSEOMetadata(productName, targetUrl, contentSummary, sources) {
        try {
...
- Keep meta description under 160 characters`;
     ...
     */
    async analyzeKeywords(productName, contentSummary, sources) {
        try {
...
Output as JSON:
{
  ...
  "difficultyScore": number
     ...
     */
    async generateKeywordSuggestions(productName, sectionName, keywords) {
        try {
...
["keyword1", "keyword2", ...]`;
     ...
     */
    validateSEOMetadata(metadata, productName, targetUrl) {
        return {
     ...
     */
    getDefaultSEOMetadata(productName, targetUrl) {
        return {
     ...
     */
    getDefaultSEOAnalysis(productName) {
        return {
     ...
     */
    getDefaultKeywordSuggestions(productName, sectionName) {
        return [
     ...
     */
    generateURLSlug(productName, sectionName) {
