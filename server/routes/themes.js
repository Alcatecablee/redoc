 ...
 */
router.get('/default', verifySupabaseAuth, async (req, res) => {
    try {
        const themeService = new ThemeService();
 ...
 */
router.put('/:id', verifySupabaseAuth, async (req, res) => {
    try {
        const themeId = parseInt(req.params.id);
        if (isNaN(themeId)) {
            return res.status(400).json({ error: 'Invalid theme ID' });
 ...
 * Delete a theme
 */
router.delete('/:id', verifySupabaseAuth, async (req, res) => {
    try {
        const themeId = parseInt(req.params.id);
        if (isNaN(themeId)) {
            return res.status(400).json({ error: 'Invalid theme ID' });
 ...
 */
router.post('/:id/set-default', verifySupabaseAuth, async (req, res) => {
    try {
        const themeId = parseInt(req.params.id);
        if (isNaN(themeId)) {
            return res.status(400).json({ error: 'Invalid theme ID' });
 ...
 */
router.post('/:id/clone', verifySupabaseAuth, async (req, res) => {
    try {
        const themeId = parseInt(req.params.id);
        if (isNaN(themeId)) {
            return res.status(400).json({ error: 'Invalid theme ID' });
