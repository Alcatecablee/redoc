 ...
 */
export function calculateSmartScaling(pageCount, githubStars, githubIssues) {
 ...
 */
export function enforceTierLimits(userPlan, smartScaling) {
    // Validate inputs
    ...
    const limitedByTier = enforcedLimits.stackOverflow < smartScaling.stackOverflow ||
 ...
 */
export function canGenerateDocumentation(userPlan, generationCount) {
    const tierLimits = TIER_CONFIG[userPlan] || TIER_CONFIG.free;
